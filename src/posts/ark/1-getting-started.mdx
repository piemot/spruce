...
<span class="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-emerald-700">Mr. Arkiletian</span>'s
course! I'm <a href="https://github.com/piemot" class="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-emerald-700">Pierson</a>,
and I put this website together to give you an alternative to Mr. Ark's videos. I graduated from Hamber last year,
...
<span class="font-semibold inline-flex items-center">View <ChevronRightIcon class="size-5" /> Change Color Scheme</span>.
